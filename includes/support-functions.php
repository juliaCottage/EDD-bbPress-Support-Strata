...
?>
	...
	<div id="edd-bbp-common-issues">
		<p style="font-size:16px; position: relative;top: -10px"><strong>Is your question about one of these issues?</strong></p>
		<p style="position: relative;left: 20px; position: relative;top: -10px"><select id="edd-bbp-common-issues-select" name="edd-bbp-common-issues">
			<option value="0">Select from common issues . . . </option>
			<option value="install-extension">I can't import Illustrator or PDF files into Design 3D</option>
			<option value="pending">When I skin 2D objects together they seem to twist</option>
			<option value="emails">When I try to animate simple objects the event markers don't show up</option>
			<option value="fes-upload">How can I create a visible light beam - like a street light in fog?</option>
			<option value="no">No, I need to start a new topic</option>
		</select>
		<div id="edd-common-ticket-answers">
			<div id="edd-common-issue-install-extension" class="bbp-template-notice" style="display:none;">
				<p>Make sure that you have installed the AI/PDF Importer for your Strata software.<a href="http://support.strata.com/index.php?action=artikel&cat=14&id=460&artlang=en"> Click here for an FAQ with more information</a>.</p>
			</div>
			<div id="edd-common-issue-pending" class="bbp-template-notice" style="display:none;">
				<p>The ribs (2D objects) need to have all of the starting points located in the same orientation and ideally have the same number of points.<a href="http://support.strata.com/index.php?action=artikel&cat=17&id=2&artlang=en"> Click here for an FAQ with more information</a>.</p>
			</div>
			<div id="edd-common-issue-emails" class="bbp-template-notice" style="display:none;">
				<p>You must turn on animation specifically for object(s) you want to have animated using the stopwatch control in the Project Window.<a href="http://support.strata.com/index.php?action=artikel&cat=4&id=175&artlang=en"> Click here for an FAQ with more info</a> and <a href="https://www.strata.com/university/tutorials/fundamentals-of-design-3d-cx-8/">click here for the Animtion Fundamentals video</a>.</p>
			</div>
			<div id="edd-common-issue-fes-upload" class="bbp-template-notice" style="display:none;">
				<p>Design 3D CX allows you to create a visible light effect for local lights (spotlights and point lights) by using a voumetric texture.<a href="http://support.strata.com/index.php?action=artikel&cat=15&id=262&artlang=en"> Click here for an FAQ with more information</a>.</p>
			</div>
		</div>
		...
		<div id="edd-bbp-google-search" style="display:none">
			<p>Enter keywords to search for issues similar to yours.</p>
			<script>
			  (function() {
